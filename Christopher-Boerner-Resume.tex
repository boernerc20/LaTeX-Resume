...
\begin{document}
    ...
    \begin{twocolentry}{{Sep 2024 -- Dec 2024} \\\textit{Blacksburg, Virginia}}
        ...
        \textbf{\textit{\hrefWithoutArrow{https://ece.vt.edu/undergrad/courses/2564.html}{Embedded Systems} \boldmath$\cdot$ Grader}}\\
        \begin{onecolentry}
            \begin{highlights}
    ...
    \textbf{Cybersecurity Infrastructure Developmen | ICAM Framework}\\

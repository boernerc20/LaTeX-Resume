...
\begin{document}
    ...
    \hrule
    \kern 5.0 pt%
    Computer Engineering Master's graduate with experience in embedded systems, digital design, and electronics. Skilled in integrating FPGA and microcontroller platforms with Ethernet and serial networks for real-time data acquisition. Strong background in systems analysis, hardware/software co-design, and validation of electronics for aerospace and power systems applications.

    % SKILLS SECTION:
    \section{Skills}
    \textbf{Languages: }C/C++, Python, Bash, Verilog, MATLAB\\
    \kern5pt
    \textbf{Hardware: }PCB design, Circuit Analysis, Power Distribution, RF, UART/SPI/I2C debugging\\
    \kern5pt
    \textbf{Software: }CMake, Git, Linux, Xilinx Vivado/Vitis, STM32CubeIDE, KiCad, LTSpice, Cadence Virtuoso\\
    \kern5pt
    \textbf{Instumentation \& Networking: }Oscilloscope, DMM, Electronic Loads, Power Supplies, Ethernet/TCP-IP, MQTT, IPv4 stack\\

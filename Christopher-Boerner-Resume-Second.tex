...
\begin{document}
    ...
    \kern 5.0 pt%
    \textbf{Networking \& Security: }TCP/IP, MQTT, SSH, Socket programming, Network configuration\\
    \kern 5.0 pt%
    \textbf{Software \& Tools: }OOP, Vivado/Vitis, STM32CubeIDE, KiCad, LTSpice, Cadence Virtuoso, Hardware-in-the-loop, Automation\\
    \kern 5.0 pt%
    \textbf{Hardware Integration: }FPGA/SoC, Circuit Design, Embedded Linux deployment, UART/SPI/I2C interfacing, Power systems\\
    ...
    \begin{twocolentry}{{Nov 2024 -- Present} \\\textit{McLean, Virginia}}
        ...
        \textbf{\textit{Pathways Space Systems Engineer}}\\
        \begin{onecolentry}
            \begin{highlights}
